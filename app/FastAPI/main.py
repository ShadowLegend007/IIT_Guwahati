    ...
    if result == "packaged_food":
        ...
        return {
            ...
            "nutrition": {
                ...
                "source_url": f"[https://world.openfoodfacts.org/product/](https://world.openfoodfacts.org/product/){product.get('code')}",
        ...
        return {
            ...
            "nutrition": {
                "per_100g": nutri,
                "source_url": f"[https://www.google.com/search?q=](https://www.google.com/search?q=){query}+nutrition",
